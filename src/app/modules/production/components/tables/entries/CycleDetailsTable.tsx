...
const CycleDetailsTable: React.FC<Props> = ({className}) => {
  return (
          ...
          <table className='table align-middle gs-0 gy-4'>
            ...
            <thead>
              <tr className='fw-bold text-muted bg-light'>
                ...
                <th className='min-w-150px'>Nominal</th>
                <th className='min-w-150px'>Weight</th>
                <th className='min-w-150px'>Payload Weight</th>
                <th className='min-w-150px'>Reported Weight</th>
                <th className='min-w-150px'>Volume</th>
                <th className='min-w-150px'>Loads</th>
                <th className='min-w-150px'>Time at loader</th>
                <th className='min-w-150px'>Time at destination</th>
                <th className='min-w-150px'>Destination</th>
